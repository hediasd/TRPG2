...
public class BoxMaker3 : MonoBehaviour
{
	//public Text letter;
	...
	public void Startup ()
	{
		...
		topLeft = (GameObject)Instantiate (corner, wheres + (new Vector3 (0, hei * 16, 0)), Quaternion.Euler (0, 0, 0));
		topRight = (GameObject)Instantiate (corner, wheres + (new Vector3 (wid * 16, hei * 16, 0)), Quaternion.Euler(0,0,270));
		bottomLeft = (GameObject)Instantiate (corner, wheres + (new Vector3 (0, 0, 0)), Quaternion.Euler (0, 0, 90));
		bottomRight = (GameObject)Instantiate (corner, wheres + (new Vector3 (wid * 16, 0, 0)), Quaternion.Euler (0, 0, 180));

		up = (GameObject)Instantiate (line, wheres + (new Vector3 (wid * 8, hei * 16, 0)), Quaternion.Euler (0, 0, 0));
		down = (GameObject)Instantiate (line, wheres + (new Vector3 (wid * 8, 0, 0)), Quaternion.Euler (0, 0, 180));
		left = (GameObject)Instantiate (line, wheres + (new Vector3 (0, hei * 8, 0)), Quaternion.Euler (0, 0, 90));
		right = (GameObject)Instantiate (line, wheres + (new Vector3 (wid * 16, hei * 8, 0)), Quaternion.Euler (0, 0, 270));

		fill = (GameObject)Instantiate (filling, wheres + (new Vector3 (wid * 8, hei * 8, 0)), Quaternion.Euler (0, 0, 0));
		arrow = (GameObject)Instantiate (arrowBase, wheres + (new Vector3 (10, 4 + (hei-1) * 16, 0)), Quaternion.Euler (0, 0, 0));
